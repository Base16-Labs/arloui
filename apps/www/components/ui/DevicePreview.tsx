...
export function DevicePreview({ route, className }: DevicePreviewProps) {
  ...
  return (
    <div className={cn("mb-12", className)}>
      ...
      <div className="hidden flex-col items-center gap-5 rounded-2xl border border-line bg-surface-sunken py-10 text-ink sm:flex dark:bg-surface-raised">
        <QRCodeSVG
          value={url}
          size={180}
          bgColor="transparent"
      ...
      <div className="flex flex-col items-center gap-3 rounded-2xl border border-line bg-surface-sunken py-8 text-ink sm:hidden dark:bg-surface-raised">
        <a
          href={url}
          target="_blank"
          rel="noopener noreferrer"
