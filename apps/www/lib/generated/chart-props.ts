...
export const CHART_PROPS: { title: string; displayTitle?: string; props: ChartPropDoc[]; parts: ChartPartDoc[] }[] = [
  {
    ...
    "props": [
      ...
      },
      {
        ...
        "required": false,
        "description": "Fires on every scrub change, controlled or not. **Called with `(null, null)` on release**, because the crosshair belongs to the finger and stops existing when the finger lifts."
      },
      {
        "name": "loading",
        "type": "boolean",
      ...
      },
      {
        ...
        "props": [
          ...
          },
          {
            ...
            "type": "ChartData",
            "required": false,
            "description": "A second series, drawn dashed in the neutral hue — the baseline a projection is measured against. It never takes the scrub: one series answers to the finger, the other is context."
          },
          {
            "name": "range",
            "type": "ChartRange",
  ...
  },
  {
    ...
    "parts": [
      ...
      },
      {
        ...
        "description": "Labels the series' own high and low in the margins above and below the mark.",
        "props": []
      },
      {
  ...
  },
  {
    ...
    "props": [
      ...
      },
      {
        ...
        "type": "number",
        "required": false,
        "description": "Ring thickness. Defaults from `density` — 16 at default, 12 at compact."
      },
      {
        "name": "edges",
        "type": "DonutEdges",
        "required": false,
        "default": "'straight'",
        "description": "How each slice ends. `'straight'` cuts radially. `'curve'` rounds the ends, the way a stroke with round caps would."
      },
      {
        "name": "density",
        "type": "ChartDensity",
  ...
  },
  {
    ...
    "props": [
      ...
      },
      {
        ...
        "required": false,
        "default": "false",
        "description": "Pulses the track and holds back the fill and the readout."
      },
      {
        "name": "refreshing",
        "type": "boolean",
    ...
    "parts": [
      ...
      },
      {
        ...
        "description": "One concentric ring, drawn inside the primary one. `value` on the meter is always the outermost; `Meter.Ring` children stack inwards in tree order, exactly as `Series` extends `data` on a bar chart.",
        "props": [
          {
            "name": "value",
            "type": "number",
